    ...
    private class AsyncFindNodes extends AsyncTask<Void, NodeInfo, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if ((d.getRpcNodes().size() < NODES_TO_FIND) &&
                ...
                seedList.add(new NodeInfo(new InetSocketAddress("51.38.184.159", 18080)));
                seedList.add(new NodeInfo(new InetSocketAddress("35.200.101.136", 18080)));
                seedList.add(new NodeInfo(new InetSocketAddress("35.185.185.76", 18080)));
